...
passwordLabel = Label(root, text='Password Generator', font=('Ariel', 20, 'bold'), bg='blue', fg='white')
...
lengthLabel = Label(root, text='Password Length', font=Font, bg='red3', fg='black')
